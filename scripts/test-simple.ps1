...
Write-Host "  TESTES DO SISTEMA - VERSAO SIMPLES   " -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
...
try {
    $client = Invoke-RestMethod -Uri "$baseUrl/api/users" -Method POST -Body $clientBody -ContentType "application/json" -SkipCertificateCheck
...
try {
    $loginResult = Invoke-RestMethod -Uri "$baseUrl/api/users/login" -Method POST -Body $loginBody -ContentType "application/json" -SkipCertificateCheck
...
try {
    $admin = Invoke-RestMethod -Uri "$baseUrl/api/users" -Method POST -Body $adminBody -ContentType "application/json" -SkipCertificateCheck
...
try {
    $adminLoginResult = Invoke-RestMethod -Uri "$baseUrl/api/users/login" -Method POST -Body $adminLoginBody -ContentType "application/json" -SkipCertificateCheck
...
try {
    ...
    $reservation = Invoke-RestMethod -Uri "$baseUrl/api/reservas" -Method POST -Body $reservationBody -ContentType "application/json" -Headers $headers -SkipCertificateCheck
...
try {
    ...
    $reservations = Invoke-RestMethod -Uri "$baseUrl/api/reservas" -Method GET -Headers $headers -SkipCertificateCheck
...
try {
    ...
    $allReservations = Invoke-RestMethod -Uri "$baseUrl/api/reservas" -Method GET -Headers $headers -SkipCertificateCheck
...
try {
    ...
    $updated = Invoke-RestMethod -Uri "$baseUrl/api/reservas/$reservationId" -Method PUT -Body $updateBody -ContentType "application/json" -Headers $headers -SkipCertificateCheck
...
try {
    ...
    $notifications = Invoke-RestMethod -Uri "$baseUrl/api/notificacoes" -Method GET -Headers $headers -SkipCertificateCheck
...
try {
    ...
    $event = Invoke-RestMethod -Uri "$baseUrl/api/eventos" -Method POST -Body $eventBody -ContentType "application/json" -Headers $headers -SkipCertificateCheck
...
try {
    ...
    $events = Invoke-RestMethod -Uri "$baseUrl/api/eventos" -Method GET -Headers $headers -SkipCertificateCheck
...
try {
    ...
    $finalNotifications = Invoke-RestMethod -Uri "$baseUrl/api/notificacoes" -Method GET -Headers $headers -SkipCertificateCheck
...
Write-Host "Diferenciacao Admin/Cliente: OK" -ForegroundColor Green
Write-Host "Reservas: OK" -ForegroundColor Green
Write-Host "Notificacoes: OK" -ForegroundColor Green
Write-Host "Eventos: OK" -ForegroundColor Green
Write-Host ""
